...
-- 正在导出表  dubbo-app.sys_dict 的数据：~2 rows (大约)
...
-- 导出  表 dubbo-app.sys_resources 结构
...
-- 正在导出表  dubbo-app.sys_resources 的数据：~22 rows (大约)
...
-- 正在导出表  dubbo-app.sys_role 的数据：~2 rows (大约)
...
-- 导出  表 dubbo-app.sys_role_resources 结构
...
-- 正在导出表  dubbo-app.sys_role_resources 的数据：~22 rows (大约)
...
-- 正在导出表  dubbo-app.sys_user 的数据：~2 rows (大约)
DELETE FROM `sys_user`;
/*!40000 ALTER TABLE `sys_user` DISABLE KEYS */;
INSERT INTO `sys_user` (`id`, `username`, `password`) VALUES
	('18151fda-09e7-4491-a7dd-4e2bdd02ecc8', '123123', '4297f44b13955235245b2497399d7a93'),
	('62619962-c88c-4530-b424-ced43b30e1ea', 'wangsong', '532da1c5da9fb86bf61b2a63487f300c');
/*!40000 ALTER TABLE `sys_user` ENABLE KEYS */;


-- 导出  表 dubbo-app.sys_user_role 结构
...
-- 正在导出表  dubbo-app.sys_user_role 的数据：~2 rows (大约)
...
INSERT INTO `sys_user_role` (`id`, `user_id`, `role_id`) VALUES
	...
	('dd93d613-a3dc-4a45-aac7-7485d3caf8e2', '18151fda-09e7-4491-a7dd-4e2bdd02ecc8', '111');
